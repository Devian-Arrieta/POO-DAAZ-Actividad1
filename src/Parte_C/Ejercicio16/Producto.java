...
class Main{
    public static void main(String[] args) {
        ...
        producto1.reabastecer(70);
        System.out.print("PRODUCTO 1 REABASTECIDO: ");
        producto1.mostrarProducto();

        producto2.reabastecer(100);
        System.out.print("PRODUCTO 2 REABASTECIDO: ");
        producto2.mostrarProducto();

        producto2.reabastecer(45);
        System.out.print("PRODUCTO 3 REABASTECIDO: ");
        producto3.mostrarProducto();
